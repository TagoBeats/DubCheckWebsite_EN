...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    { url: `${SITE_URL}/specs`,          lastModified: now, changeFrequency: 'monthly', priority: 0.7 },
    { url: `${SITE_URL}/specs/acx`,      lastModified: now, changeFrequency: 'monthly', priority: 0.8 },
    ...
    { url: `${SITE_URL}/specs/apple-digital-masters`, lastModified: now, changeFrequency: 'monthly', priority: 0.8 },
